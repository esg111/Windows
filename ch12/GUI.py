...
from tkinter import ttk, scrolledtext, Menu, \
    Spinbox, filedialog as fd, messagebox as mBox
from ToolTip import ToolTip
from queue import Queue
from os import path
from LanguageResources import I18N
from Callbacks_ReFactored import Callbacks
from ch12.Logger import Logger, LogLevel
from ch12.GUI_MySQL_class import MySQL
...
class OOP():
    def __init__(self, language='ko'):
        ...
        self.i18n = I18N(language)  # use Korean
        ...
        self.callback.defaultFileEntries()
    ...
    def createWidgets(self):
        ...
        # Adding a Button
        self.action = ttk.Button(self.mySQL, text="Insert Quote", command=self.callback.insertQuote)
        self.action.grid(column=2, row=1)

        # Adding a Button
        self.action1 = ttk.Button(self.mySQL, text="Get Quotes", command=self.callback.getQuote)
        self.action1.grid(column=2, row=2)

        # Adding a Button
        self.action2 = ttk.Button(self.mySQL, text="Mody Quote", command=self.callback.modifyQuote)
        ...
        self.combo.bind('<<ComboboxSelected>>', self.callback._combo)

        # Adding a Spinbox widget using a set of values
        self.spin = Spinbox(self.widgetFrame, values=(1, 2, 4, 42, 100), width=5, bd=8, command=self.callback._spin)
        ...
        self.allTZs = ttk.Button(self.widgetFrame,
                                 ...
                                 command=self.callback.allTimeZones)
        ...
        self.localTZ = ttk.Button(self.widgetFrame,
                                  ...
                                  command=self.callback.localZone)
        ...
        self.dt = ttk.Button(self.widgetFrame,
                             ...
                             command=self.callback.getDateTime)
        ...
        fileMenu.add_command(label=self.i18n.exit, command=self.callback._quit)
